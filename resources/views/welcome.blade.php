        ...
        <div class="jumbotron bg-light p-5 rounded-3 shadow-sm mb-5">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    @else
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                            <a href="{{ route('reclamations.index') }}" class="btn btn-primary btn-lg px-4 me-2">
                                <i class="bi bi-folder2-open"></i> Mes Réclamations
                            </a>
                            <a href="{{ route('reclamations.create') }}" class="btn btn-success btn-lg px-4">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-3">
                                <h3 class="text-primary">{{ auth()->user()->reclamations->count() }}</h3>
                                <p class="text-muted mb-0">Total Réclamations</p>
                            </div>
                            <div class="col-md-3">
                                <h3 class="text-warning">{{ auth()->user()->reclamations->where('statut', 'en_attente')->count() }}</h3>
                                <p class="text-muted mb-0">En Attente</p>
                            </div>
                            <div class="col-md-3">
                                <h3 class="text-info">{{ auth()->user()->reclamations->where('statut', 'en_cours')->count() }}</h3>
                                <p class="text-muted mb-0">En Cours</p>
                            </div>
                            <div class="col-md-3">
                                <h3 class="text-success">{{ auth()->user()->reclamations->where('statut', 'resolue')->count() }}</h3>
